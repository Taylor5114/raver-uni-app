...
var _mineData = _interopRequireDefault(__webpack_require__(/*! @/common/data/mine.data.js */ 68));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };} //
//
//
//
//
...
//
//
var uviewAvatar = function uviewAvatar() {__webpack_require__.e(/*! require.ensure | components/avatar/index */ "components/avatar/index").then((function () {return resolve(__webpack_require__(/*! @/components/avatar/index.vue */ 78));}).bind(null, __webpack_require__)).catch(__webpack_require__.oe);};var vipCard = function vipCard() {__webpack_require__.e(/*! require.ensure | components/vip-card */ "components/vip-card").then((function () {return resolve(__webpack_require__(/*! @/components/vip-card.vue */ 83));}).bind(null, __webpack_require__)).catch(__webpack_require__.oe);};var mineList = function mineList() {__webpack_require__.e(/*! require.ensure | components/mine-list */ "components/mine-list").then((function () {return resolve(__webpack_require__(/*! @/components/mine-list.vue */ 90));}).bind(null, __webpack_require__)).catch(__webpack_require__.oe);};var _default = { components: { uviewAvatar: uviewAvatar, vipCard: vipCard, mineList: mineList }, data: function data() {return { mineList: _mineData.default.mineList, mineData: Object };}, methods: {}, onLoad: function onLoad() {var _this = this;uni.request({
      url: 'https://mock.mengxuegu.com/mock/608f846e1d10f86a7bd6adad/tay/mine_data',
      success: function success(res) {
        _this.mineData = res.data;
      } });
